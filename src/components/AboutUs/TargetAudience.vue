<template>
<div class="container mx-auto px-4 md:px-0 tepcot-overlap relative py-10 md:py-20">
  <div class="">
  ...
  <div class=" grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 py-8">
    <div v-for="(card, index) in itemList" :key="index" class="rounded-xl   border border-blue-300/50 p-4">
    <CardBlur
      class="text-blue-900"
      :icon="card.icon"
      :title="card.title"
  ...
  <div class=" bg-blue-300/10 p-4 rounded-2xl shadow-sm  hover:ring-1 hover:ring-blue-500/30">
     <h4 class="tracking-tight text-a-blue-030e62 text-36 sm:text-44 flex items-center gap-4">
