...
<div class="container mx-auto px-4 md:px-0 tepcot-overlap relative pb-20">
  ...
  <div class=" grid grid-cols-2 md:grid-cols-5 gap-2 py-8 md:gap-6 md:py-12">

  <div v-for="(card, index) in itemList" :key="index" class=" shadow-lg shadow-blue-100/40 rounded-xl">
